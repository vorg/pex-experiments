...
GUI.prototype.draw = function () {
    ...
    this.texture2DProgram.setUniform('uHDR', 0);
    this.texture2DProgram.setUniform('uFlipEnvMap', 1);
...
GUI.prototype.drawTextures = function () {
  ...
  for (var i = 0; i < this.items.length; i++) {
    ...
    if (item.type == 'texture2D') {
      ...
      this.texture2DProgram.setUniform('uFlipEnvMap', item.options.flipEnvMap ? item.options.flipEnvMap : 1);
      ctx.drawMesh();
    }

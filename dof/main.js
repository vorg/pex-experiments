...
var BoxBlurDOF      = require('./fx/BoxBlurDof');
...
Window.create({
    ...
    draw: function() {
        ...
        var final = color.boxBlurDof({ depthMap: this.depthMap, depth: State.depth, depthRange: State.depthRange, camera: this.camera })
        final.blit()
